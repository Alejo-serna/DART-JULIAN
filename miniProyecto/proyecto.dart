...
void main() {
  // ALEJANDRO SERNA - MINI PROYECTO JULIAN
...
void mostrarTemas() {
  if (temas.isEmpty) {
    ...
    for (int i = 0; i < temas.length; i++) {
      print(
          '${i + 1}. ${temas[i].nombre} (${temas[i].numEstudiantes} estudiantes)');
    }
  }
}
...
void asignarEstudiantesAleatoriamente() {
  ...
  for (var tema in temas) {
    int cantidadAsignar =
        min(tema.numEstudiantes, estudiantesSinAsignar.length);
