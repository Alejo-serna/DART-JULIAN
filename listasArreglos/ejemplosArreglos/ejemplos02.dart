void main() {
  ...
  print(numeros2);
  numeros2.remove(5);     // Elimina la posicion. Para eliminar la pocision de un elemento de una lista.
  print(numeros2);
  print(numeros2[4]);
  numeros2.removeAt(1);   // Elimina la posicion. Para eliminar la pocision de un elemento de una lista.
